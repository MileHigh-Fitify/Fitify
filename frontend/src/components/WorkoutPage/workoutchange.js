...
const ChangeworkoutPlan = (props) => {
    ...
    useEffect(
        async ()=>{
            await axios.get(`http://localhost:5000/workoutplan/${auth}`)
            .then(res=>{
                    setWorkout(res.data); 
            })
        },[]
    ...
    const createPlan = async ()=>{
        ...
        await axios.post("http://localhost:5000/preworkout/", form)
             .then(res => {
        ...
        console.log(form1)
         ...
         await axios.post("http://localhost:5000/workoutplan/add", form1)
             .then(res => {
    ...
    const updatePlan = async ()=>{
        ...
        console.log(form1)
         ...
         await axios.post(`http://localhost:5000/workoutplan/update/${auth}`, form1)
             .then(res => {
                 window.alert(res.data);
                 window.location = "/workout"
        })
